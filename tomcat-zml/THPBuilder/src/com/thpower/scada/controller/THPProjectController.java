...
//        	}  
	...
	public void getAllProjects(HttpServletRequest request, HttpServletResponse response, 
        ...
        try
        {
            List<THPProject> projects = _proMapper.getAllProjects();
        
        	//rows
			List<Map<String,Object>> listp=new ArrayList<Map<String,Object>>();  
			
			for(THPProject project : projects)
			{
				Map<String,Object> mapff = MapUtil.objectToMap(project);					
	...
	@RequestMapping("/getSharedProjects")
	public void getSharedProjects(@RequestParam("userId") long userId,
			HttpServletRequest request, HttpServletResponse response, 
			Model model
			) throws IOException{
        ...
        try
        {
            List<THPProject> projects = _proMapper.getSharedProjects(userId);
	...
	public void validateProjectName(HttpServletRequest request, HttpServletResponse response, 
			Model model ) throws IOException{
        ...
        */
        ...
        try 
        {        	
        	List<THPProject> projects = _proMapper.validateProjectName(proName);

        	int nrows = projects.size();
	...
	public void deleteProject(HttpServletRequest request, HttpServletResponse response, 
        ...
        */
        ...
        try 
        {        	
        	int nrows = _proMapper.delete(proId);
