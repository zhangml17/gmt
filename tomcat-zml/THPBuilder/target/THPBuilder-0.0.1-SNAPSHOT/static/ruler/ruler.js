...
ruler.prototype.builder = function () {
    ...
    var setSize = function (width, height) {
        theRulerDOM.style.width = width+'px';
        theRulerDOM.style.height = height+'px';
    };
 ...
 */
ruler.prototype.guideLine = function (line, _dragContainer, lineDimension, options, curDelta, moveCB, event, sacale) {
