...
function Dialog(editorUi, elt, w, h, modal, closable, onClose)
{
	...
	if (closable)
	{
		...
		//control img postion,modify by wugh at 2018.5.12
		img.style.top = (top + 10) + 'px';
		img.style.left = (left + w - 20 - dx) + 'px';
...
PageSetupDialog.addPageFormatPanel = function(div, namePostfix, pageFormat, pageFormatListener)
{
	...
	// Close paper rotation --zhanglw 2018.8.15
...
{
	return [
	        {key: 'p1', title: '240*320', format: new mxRectangle(0, 0, 240, 320)},
	        {key: 'p2', title: '352*480', format: new mxRectangle(0, 0, 352, 480)},
	        {key: 'p3', title: '480*800', format: new mxRectangle(0, 0, 480, 800)},
	        {key: 'p4', title: '600*1024', format: new mxRectangle(0, 0, 600, 1024)},
	        {key: 'p5', title: '720*1280', format: new mxRectangle(0, 0, 720, 1280)},
	        {key: 'p6', title: '768*1024', format: new mxRectangle(0, 0, 768, 1024)},
	        {key: 'p7', title: '800*1280', format: new mxRectangle(0, 0, 800, 1280)},
	        {key: 'm1', title: '800*600', format: new mxRectangle(0, 0, 800, 600)},
	        {key: 'm2', title: '960*600', format: new mxRectangle(0, 0, 960, 600)},
	        {key: 'm3', title: '1024*600', format: new mxRectangle(0, 0, 1024, 600)},
	        {key: 'm4', title: '1024*768', format: new mxRectangle(0, 0, 1024, 768)},
	        {key: 'm5', title: '1280*768', format: new mxRectangle(0, 0, 1280, 768)},
	        {key: 'm6', title: '1280*1024', format: new mxRectangle(0, 0, 1280, 1024)},
	        {key: 'm7', title: '1360*768', format: new mxRectangle(0, 0, 1360, 768)},
	        {key: 'm8', title: '1366*768', format: new mxRectangle(0, 0, 1366, 768)},
...
mxObjectCodec.prototype.encodeObject = function(enc, obj, node)
{
	...
	if(obj&&obj.parent&&obj.parent.id ){
		var value = obj.parent.id ;
		this.writeAttribute(enc, obj, "parent", value, node);
	}
    for (var i in obj)
    {
    	if(i=="children" || i=="parent" || i=="map") continue;
		var name = i;
		var value = obj[name];
